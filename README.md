...
Prompt 总量、时段热力图、平台分布、活跃项目 Top 5、高频 Prompt 短语云——一眼看清 AI 使用全貌。

![Mirscope 全景看板](docs/assets/dashboard.png)

### 对话时间线

按 Cursor / Trae / Claude Code 分类浏览，逐条回看真实 Prompt，支持项目画像分析。

![Mirscope 对话时间线](docs/assets/timeline.png)

### 设置与采集

自动检测本地 IDE 安装路径，支持 JSON/CSV 导出、SQLite 备份，以及各平台单独同步。

![Mirscope 设置与采集插件](docs/assets/settings.png)

[→ 查看更多产品介绍](https://mrsongzhaoyang.github.io/Mirscope/)
